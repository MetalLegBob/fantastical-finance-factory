...
pub enum VaultError {
    ...
    #[msg("Account passed is not the PROFIT mint")]
    InvalidMint,

    #[msg("Destination ATA does not match the canonical Squads vault PROFIT ATA")]
    InvalidDestination,

    #[msg("Migration already executed — MigrationConfig PDA exists")]
